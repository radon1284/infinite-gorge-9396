class StaffsController < ApplicationController
  ...
  private
    ...
    def staff_params
      params.require(:staff).permit(:full_name, :position, user_attributes: [ :id, :email, :password , :role, :user_id, :admin_id, :manager_id, :team_leader_id, :staff_id, :client_id])
    end
    
    def update_staff_params
      params.require(:staff).permit(:full_name, :position, user_attributes: [ :id , :role, :user_id, :admin_id, :manager_id, :team_leader_id, :staff_id, :client_id], client_ids:[], employment_attributes:[:multiplier])
    end
end
